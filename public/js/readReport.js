window.onload = function () {
    ...
    let formDiv = document.getElementById("holderbox");
    let onDateRadio = document.getElementById("onDate");
    let testDate = document.getElementById("testDate");
    let dateRangeRadio = document.getElementById("dateRange");
    let dateRange1 = document.getElementById("dateRange1");
    let dateRange2 = document.getElementById("dateRange2");
    let withinDaysRadio = document.getElementById("onDays");
    let withinDays = document.getElementById("withinDays");
    let fileInput = document.getElementById("sourceUpload");
    let dateValue = document.getElementById("testDate");
    let subButton = document.getElementById("submitBut");
    let cateCheck = document.getElementById("categoryCheck");
    let cateSel = document.getElementById("caterogyList");
    let envir1Chb = document.getElementById("envir1Chb");
    let envir2Chb = document.getElementById("envir2Chb");
    let envir3Chb = document.getElementById("envir3Chb");
    let chartDiv = document.getElementById("charts");
    let resultDiv = document.getElementById("reportList");

    //bind event linsteners
    document.querySelectorAll("#onDate,#dateRange,#onDays").forEach(function (ele) {
        ele.addEventListener("change", function () {
            onDayChange();
        });
    });
    document.querySelectorAll("#testDate,#cateValue,#envir1Chb,#envir2Chb,#envir3Chb").forEach(function (ele) {
        ele.addEventListener("change", function () {
            validateButton();
        });
    });
    document.querySelectorAll("#dateRange1,#dateRange2").forEach(function (ele) {
        ele.addEventListener("change", function () {
            limitDateRange();
        });
    });
    document.querySelector("#categoryCheck").addEventListener("change", function () {
        onCateChange();
    });
